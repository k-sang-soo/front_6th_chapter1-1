(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`/front_6th_chapter1-1`,t=(t=window.location.pathname)=>t.startsWith(e)?t.slice(21)||`/`:t,n=t=>e+t;let r={currentPath:`/`,currentParams:{},currentMatch:null,subscribers:[]};function i(e){return e.replace(/^\/+|\/+$/g,``).split(`/`).filter(Boolean)}function a(e){return e&&e[0]===`:`}function o(e,t,n={}){for(let r of t){let t=r.path.split(`/`).filter(Boolean);if(t.length>e.length)continue;let i=!0,s={...n};for(let n=0;n<t.length;++n){let r=t[n];if(a(r)){let t=r.slice(1);s[t]=e[n]}else if(r!==e[n]){i=!1;break}}if(!i)continue;let c=e.slice(t.length);if(c.length===0&&r.component)return r.layout?{layout:r.layout,component:r.component,params:s}:{component:r.component,params:s};if(r.children&&c.length===0){let e=r.children.find(e=>e.path===``);if(e)return r.layout?{layout:r.layout,component:e.component,params:s}:{component:e.component,params:s}}if(r.children&&c.length>0){let e=o(c,r.children,s);if(e)return r.layout?{layout:r.layout,component:e.component,params:e.params}:e}}return null}function s(e,t){r.currentPath=e,r.currentParams=t?t.params:{},r.currentMatch=t,r.subscribers.forEach(e=>{e(r)})}function c(e){let n=null,r=t=>{let r=i(t),a=o(r,e),c=document.getElementById(`root`);c.innerHTML=``;let l=document.createElement(`div`);if(c.appendChild(l),n&&typeof n.unmount==`function`&&n.unmount(),s(t,a),a)a.layout?(n=new a.layout(l,{...a.params,children:a.component}),n.mount()):a.component&&(n=new a.component(l,a.params),n.mount());else{let t=e.find(e=>e.path===`404`);t&&(n=new t.component(l),n.mount())}},a=e=>{let n=e.target.closest(`a[data-link]`);if(n){e.preventDefault();let i=n.getAttribute(`href`);window.history.pushState({},``,i),r(t(window.location.pathname))}};return window.addEventListener(`popstate`,()=>{r(t(window.location.pathname))}),document.body.addEventListener(`click`,a),r(t(window.location.pathname)),{renderRoute:r}}const l={push(e,t={}){t.replace?window.history.replaceState({},``,e):window.history.pushState({},``,e),window.dispatchEvent(new Event(`popstate`))},replace(e){this.push(e,{replace:!0})},back(){window.history.back()},forward(){window.history.forward()},getCurrentRoute(){return{path:r.currentPath,params:r.currentParams,match:r.currentMatch}},isCurrentPath(e){return r.currentPath===e},isCurrentPathStartsWith(e){return r.currentPath.startsWith(e)},subscribe(e){return r.subscribers.push(e),()=>{let t=r.subscribers.indexOf(e);t>-1&&r.subscribers.splice(t,1)}}};function u(){return{...l,state:r}}const d=`modulepreload`,f=function(e){return`/front_6th_chapter1-1/`+e},p={},m=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=f(t,n),t in p)return;p[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``,o=!!n;if(o)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let s=document.createElement(`link`);if(s.rel=r?`stylesheet`:d,r||(s.as=`script`),s.crossOrigin=``,s.href=t,a&&s.setAttribute(`nonce`,a),document.head.appendChild(s),r)return new Promise((e,n)=>{s.addEventListener(`load`,e),s.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[]){if(e.status!==`rejected`)continue;i(e.reason)}return e().catch(i)})};var h=class{constructor(e,t){this.element=e,this.props=t,this.state={},this.mounted=!1,this.eventListeners=[]}setState(e){this.state={...this.state,...e},this.mounted&&this.render()}addEventListener(e,t,n){e.addEventListener(t,n),this.eventListeners.push({element:e,event:t,handler:n})}mount(){this.mounted=!0,this.onMount(),this.render(),this.attachEventListeners()}unmount(){this.mounted=!1,this.onUnmount(),this.eventListeners.forEach(({element:e,event:t,handler:n})=>{e.removeEventListener(t,n)}),this.eventListeners=[]}onMount(){}onUnmount(){}render(){}attachEventListeners(){}},g=h,_=class{state={};listeners=[];constructor(e){this.state=e}getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach(e=>e(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}},v=_;const y=new v({isOpen:!1});var b=y,x=class{constructor(e=window.localStorage){this.storage=e,this.listeners={}}get(e){let t=this.storage.getItem(e);try{return JSON.parse(t)}catch{return t}}set(e,t){let n=typeof t==`string`?t:JSON.stringify(t);this.storage.setItem(e,n),this.notify(e)}remove(e){this.storage.removeItem(e)}clear(){this.storage.clear()}subscribe(e,t){return this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t),()=>{this.listeners[e]=this.listeners[e].filter(e=>e!==t)}}notify(e){if(!this.listeners[e])return;let t=this.get(e);this.listeners[e].forEach(e=>e(t))}},S=x;const C=new S;var w=C,T=class extends g{constructor(e,t){super(e,t),this.unsubscribeCartStorage=null,this.unsubscribeRouter=null,this.router=u()}onMount(){this.unsubscribeCartStorage=w.subscribe(`shopping_cart`,()=>{this.render()}),this.unsubscribeRouter=this.router.subscribe(()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage(),this.unsubscribeRouter&&this.unsubscribeRouter()}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{e.target.closest(`#cart-icon-btn`)&&b.setState({isOpen:!0}),e.target.closest(`#back-btn`)&&this.router.back()})}renderNormalHeader(){return`
    ...
    `}render(){let e=this.router.isCurrentPathStartsWith(`/detail`),t=w.get(`shopping_cart`)||[],n=t.length||0;this.element.innerHTML=`
    ...
    `}},ee=T,te=class extends g{render(){this.element.innerHTML=`
      <footer class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto py-8 text-center text-gray-500">
          <p>© 2025 항해플러스 프론트엔드 쇼핑몰</p>
        </div>
      </footer>
    `}},ne=te;const E={comma:e=>e.toString().replace(/\B(?=(\d{3})+(?!\d))/g,`,`)},D=new v({isOpen:!1,type:`success`,message:``});var O=D;function k({message:e,type:t=`info`,duration:n=3e3}){D.setState({isOpen:!0,type:t,message:e}),n>0&&setTimeout(()=>{A()},n)}function A(){D.setState({isOpen:!1})}function j(e,t){k({message:e,type:`success`,duration:t})}function M(e,t){k({message:e,type:`info`,duration:t})}var N=class extends g{constructor(e,t){super(e,t),this.unsubscribeCartStorage=null}onMount(){this.unsubscribeCartStorage=w.subscribe(`shopping_cart`,()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage()}closeCartModal(){b.setState({isOpen:!1})}handleSelectAllItems(e){let t=e.map(e=>({...e,isSelected:!e.isSelected}));w.set(`shopping_cart`,t)}handleSelectItem(e,t){let n=e.map(e=>e.productId===t?{...e,isSelected:!e.isSelected}:e);w.set(`shopping_cart`,n)}handleChangeQuantity(e,t,n){let r=e.map(e=>{if(e.productId!==t)return e;let r=e.quantity;return n===`increase`?r+=1:n===`decrease`&&(r=Math.max(1,e.quantity-1)),{...e,quantity:r}});w.set(`shopping_cart`,r)}handleRemoveItem(e,t){let n=e.filter(e=>e.productId!==t);w.set(`shopping_cart`,n),M(`선택한 상품이 삭제되었습니다`)}handleClearAllItems(){w.set(`shopping_cart`,[]),w.remove(`shopping_cart`),M(`장바구니가 비워졌습니다`)}handleSelectedRemoveItem(e){let t=e.filter(e=>!e.isSelected);w.set(`shopping_cart`,t),M(`선택된 상품들이 삭제되었습니다`)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=e.target.closest(`#cart-modal-close-btn`);if(t){this.closeCartModal();return}let n=b.getState(),r=e.target.closest(`#cart-content`);if(!r&&n.isOpen){this.closeCartModal();return}let i=w.get(`shopping_cart`),a=e.target.closest(`.quantity-decrease-btn`);if(a){let e=a.dataset.productId;this.handleChangeQuantity(i,e,`decrease`);return}let o=e.target.closest(`.quantity-increase-btn`);if(o){let e=o.dataset.productId;this.handleChangeQuantity(i,e,`increase`);return}let s=e.target.closest(`.cart-item-checkbox`);if(s){let e=s.dataset.productId;this.handleSelectItem(i,e);return}let c=e.target.closest(`#cart-modal-select-all-checkbox`);c&&this.handleSelectAllItems(i);let l=e.target.closest(`.cart-item-remove-btn`);if(l){let e=l.dataset.productId;this.handleRemoveItem(i,e)}let u=e.target.closest(`#cart-modal-clear-cart-btn`);u&&this.handleClearAllItems();let d=e.target.closest(`#cart-modal-remove-selected-btn`);d&&this.handleSelectedRemoveItem(i)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.closeCartModal()})}renderCartEmpty(){return`
      <!-- 빈 장바구니 -->
              ...
              <div class="p-4 space-y-4">
                ...
                focus:ring-blue-500"
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm text-gray-600 mt-1">${E.comma(e.lprice)}원</p>
                    <!-- 수량 조절 -->
      ...
      <div class="sticky bottom-0 bg-white border-t border-gray-200 p-4">
        ...
        ${e?`
              <div class="flex justify-between items-center mb-3 text-sm">
                ...
                <span class="font-medium">${E.comma(t)}원</span>
              </div>
            `:``}
        ...
        <div class="flex justify-between items-center mb-4">
          ...
          <span class="text-xl font-bold text-blue-600">${E.comma(n)}원</span>
        </div>
        <!-- 액션 버튼들 -->
        <div class="space-y-2">
          ${e?`<button
    ...
    `}render(){let e=w.get(`shopping_cart`)||[],t=e.length>0&&e.every(e=>e.isSelected),n=e.filter(e=>e.isSelected),r=n.length||0,i=n.reduce((e,t)=>e+t.lprice*t.quantity,0),a=e.reduce((e,t)=>e+t.lprice*t.quantity,0);this.element.innerHTML=`
      <div
    ...
    `}},P=N;const F={success:{bg:`bg-green-600`,icon:` <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        stroke-width="2"
      ...
      <path
        ...
        d="M6 18L18 6M6 6l12 12"
      />
    </svg>`}};var I=class extends g{constructor(e,t){super(e,t)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=O.getState(),n=e.target.closest(`#toast-close-btn`);n&&t.isOpen&&A()})}renderToast(e,t){let{bg:n,icon:r}=F[e]||F.info;return`
      <div
    ...
    </div>`}},L=I,R=class extends g{constructor(e,t){super(e,t),this.cartInstance=null,this.toastInstance=null,this.unsubscribeCart=null,this.unsubscribeToast=null}render(){this.element.innerHTML=`
    ...
    `,new ee(this.element.querySelector(`#header`)).mount(),new ne(this.element.querySelector(`#footer`)).mount(),this.props&&this.props.children&&new this.props.children(this.element.querySelector(`#content`),this.props).mount(),this.updateCart(b.getState()),this.updateCart(O.getState()),this.unsubscribeCart||=b.subscribe(this.updateCart.bind(this)),this.unsubscribeToast||=O.subscribe(this.updateToast.bind(this))}updateCart(e){let t=this.element.querySelector(`#cart`);t&&(this.cartInstance&&(this.cartInstance.unmount(),this.cartInstance=null),t.innerHTML=``,e.isOpen&&(this.cartInstance=new P(t),this.cartInstance.mount()))}updateToast(e){let t=this.element.querySelector(`#toast`);t&&(this.toastInstance&&(this.toastInstance.unmount(),this.toastInstance=null),t.innerHTML=``,e.isOpen&&(this.toastInstance=new L(t),this.toastInstance.mount()))}onUnmount(){this.unsubscribeCart&&this.unsubscribeCart(),this.unsubscribeToast&&this.unsubscribeToast(),this.cartInstance&&this.cartInstance.unmount(),this.toastInstance&&this.toastInstance.unmount()}},z=R;async function B(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);if(!c.ok){let e=await c.json();throw Error(e.message||`상품 목록 조회 실패`)}return await c.json()}async function V(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function H(){let e=await fetch(`/api/categories`);return await e.json()}var U=class extends g{constructor(e,t){super(e,t),this.state={loading:!0,product:null,quantity:1,relatedProducts:null},this.unsubscribeCartStorage=null}async onMount(){let e=await V(this.props.id),t=await B({category1:e.category1,category2:e.category2});this.setState({loading:!1,product:e,relatedProducts:t}),this.unsubscribeCartStorage=w.subscribe(`shopping_cart`,()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage()}handleChangeQuantity(e){e===`increase`?this.setState({...this.state,quantity:this.state.quantity+1}):e===`decrease`&&this.setState({...this.state,quantity:Math.max(1,this.state.quantity-1)})}handleAddCartItem(e,t){let{quantity:n}=this.state,r=e.find(e=>e.productId===t.productId),i;if(r)i=e.map(e=>e.productId===t.productId?{...e,quantity:e.quantity+n}:e);else{let r={...t,quantity:n,isSelected:!1};i=[...e,r]}w.set(`shopping_cart`,i),j(`장바구니에 추가되었습니다`)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=e.target.closest(`.go-to-product-list`);if(t){l.push(n(`/`));return}let r=e.target.closest(`#quantity-decrease`);if(r){this.handleChangeQuantity(`decrease`);return}let i=e.target.closest(`#quantity-increase`);if(i){this.handleChangeQuantity(`increase`);return}let a=w.get(`shopping_cart`)||[],o=e.target.closest(`#add-to-cart-btn`);if(o){this.handleAddCartItem(a,{productId:this.state.product.productId,title:this.state.product.title,image:this.state.product.image,lprice:this.state.product.lprice});return}let s=e.target.closest(`.related-product-card`);if(s){let e=s.dataset.productId;l.push(n(`/detail/${e}`));return}let c=e.target.closest(`.breadcrumb-link`);if(c){let e=c.dataset.category1?`?category1=${this.state.product.category1}`:`?category1=${this.state.product.category1}&category2=${this.state.product.category2}`;l.push(n(`/${e}`))}}),this.addEventListener(this.element,`change`,e=>{let t=e.target.closest(`#quantity-input`);t&&this.setState({...this.state,quantity:t.value})})}renderLoadingUI(){return`
    ...
    `}render(){let{product:e}=this.state;this.element.innerHTML=` <main class="max-w-md mx-auto px-4 py-4">
      ${this.state.loading?this.renderLoadingUI():`
          ...
          `}
    </main>`}},W=U,G=class extends g{render(){this.element.innerHTML=`
    ...
    `}},re=G,K=class extends g{constructor(e,t){super(e,t)}addCartItem(){let{productId:e,title:t,image:n,lprice:r}=this.props,i=w.get(`shopping_cart`)||[],a=i.findIndex(t=>t.productId===e);a>-1?i[a].quantity+=1:i.push({productId:e,title:t,image:n,lprice:r,quantity:1,isSelected:!1}),w.set(`shopping_cart`,i)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{if(e.target.id===`cart-add-button`){e.stopPropagation(),this.addCartItem(),j(`장바구니에 추가되었습니다`,3e3);return}let t=e.target.closest(`.product-card`);if(t){let e=t.dataset.productId;l.push(n(`/detail/${e}`))}})}render(){let{productId:e,title:t,image:n,lprice:r,brand:i}=this.props;this.element.innerHTML=`
    ...
    `}},q=K,J=class extends g{constructor(e,t){super(e,t)}render(){this.element.innerHTML=`
    ...
    `}},Y=J,X=class extends g{constructor(e,t){super(e,t)}renderNextPageLoading(){return this.props.products&&!this.props.products.pagination.hasNext?``:`
    ...
    `;let e=this.element.querySelector(`#products-grid`);if(this.props.loading){let t=document.createDocumentFragment();[...[,,,,]].forEach(()=>{let e=document.createElement(`div`);new Y(e).mount(),t.appendChild(e)}),e.appendChild(t);return}if(this.props.products.products){let t=this.props.products.products,n=document.createDocumentFragment();t.forEach(e=>{let t=document.createElement(`div`);new q(t,e).mount(),n.appendChild(t)}),e.appendChild(n)}}},ie=X,ae=class extends g{constructor(e,t){super(e,t)}render(){this.props.loading&&(this.element.innerHTML=`
    ...
    `}},ce=se;const Z={updateUrlParams:e=>{let t=new URL(window.location),n=new URLSearchParams(t.search);Object.entries(e).forEach(([e,t])=>{t&&t!==``?n.set(e,t):n.delete(e)});let r=`${t.pathname}?${n.toString()}`;window.history.pushState({},``,r)}},Q=1,le=20,ue=`price_asc`,de=``,fe=``,pe=``;var $=class extends g{constructor(e,t){super(e,t);let n=new URLSearchParams(window.location.search);this.state={loading:!0,error:null,products:null,categories:null,query:{page:Number(n.get(`page`))||Q,limit:Number(n.get(`limit`))||le,sort:n.get(`sort`)||ue,search:n.get(`search`)||de,category1:n.get(`category1`)||fe,category2:n.get(`category2`)||pe}}}async fetchProductsAndCategories(){try{let[e,t]=await Promise.all([B(this.state.query),H()]);this.setState({...this.state,loading:!1,products:e,categories:t,error:null})}catch(e){this.setState({...this.state,loading:!1,error:e.message})}}onMount(){this.fetchProductsAndCategories()}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=e.target.closest(`#retry-btn`);t&&(console.log(`retryBtn`),this.setState({...this.state,error:null,loading:!0}),this.fetchProductsAndCategories())})}fetchProducts({page:e,limit:t,sort:n,search:r,category1:i,category2:a}){return B({page:e,limit:t,sort:n,search:r,category1:i,category2:a})}handleLimitChange=async e=>{let t=Number(e),n=await this.fetchProducts({...this.state.query,page:this.state.query.page,limit:t});this.setState({...this.state,loading:!1,products:n,query:{...this.state.query,limit:t}}),Z.updateUrlParams({limit:e})};handleSortChange=async e=>{let t=e,n=await this.fetchProducts({...this.state.query,page:Q,sort:t});this.setState({...this.state,loading:!1,products:n,query:{...this.state.query,page:Q,sort:t}}),Z.updateUrlParams({sort:t})};handleSearchChange=async e=>{let t=e,n=await this.fetchProducts({...this.state.query,page:Q,search:t});this.setState({...this.state,loading:!1,products:n,query:{...this.state.query,page:Q,search:t}}),Z.updateUrlParams({search:t,page:Q})};handleCategoryChange=async(e=``,t=``)=>{let n=await this.fetchProducts({...this.state.query,page:Q,category1:e,category2:t});this.setState({...this.state,loading:!1,products:n,query:{...this.state.query,page:Q,category1:e,category2:t}}),Z.updateUrlParams({category1:e,category2:t,page:Q})};fetchNextPageProducts=async()=>{if(this.state.loading||!this.state.products?.pagination?.hasNext)return;let e=this.state.query.page+1,t=await this.fetchProducts({...this.state.query,page:e,limit:this.state.query.limit,sort:this.state.query.sort});this.setState({...this.state,loading:!1,products:{...t,products:[...this.state.products.products,...t.products]},query:{...this.state.query,page:e}})};renderErrorUI(){return`
      <div class="text-center my-4 py-20 shadow-md p-6 bg-white rounded-lg">
        <svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="blueGradient" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  `;this.element.innerHTML=`
      ...
      <br />
      ${u}
  `}},ge=he;const _e=[{path:``,layout:z,children:[{path:``,component:me},{path:`detail/:id`,component:W},{path:`example`,component:ge}]},{path:`404`,component:re}],ve=()=>m(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-CPuL9w3I.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));function ye(){c(_e)}ve().then(ye);