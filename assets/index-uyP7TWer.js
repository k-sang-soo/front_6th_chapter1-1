var e=function(exports){function t(e){"@babel/helpers - typeof";return t=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},t(e)}function n(e,n){if(t(e)!=`object`||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var i=r.call(e,n||`default`);if(t(i)!=`object`)return i;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(n===`string`?String:Number)(e)}function r(e){var r=n(e,`string`);return t(r)==`symbol`?r:r+``}function i(e,t,n){return(t=r(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}return exports.defineProperty=i,exports}({});(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();let t={currentPath:`/`,currentParams:{},currentMatch:null,subscribers:[]};function n(e){return e.replace(/^\/+|\/+$/g,``).split(`/`).filter(Boolean)}function r(e){return e&&e[0]===`:`}function i(e,t,n={}){for(let a of t){let t=a.path.split(`/`).filter(Boolean);if(t.length>e.length)continue;let o=!0,s={...n};for(let n=0;n<t.length;++n){let i=t[n];if(r(i)){let t=i.slice(1);s[t]=e[n]}else if(i!==e[n]){o=!1;break}}if(!o)continue;let c=e.slice(t.length);if(c.length===0&&a.component)return a.layout?{layout:a.layout,component:a.component,params:s}:{component:a.component,params:s};if(a.children&&c.length===0){let e=a.children.find(e=>e.path===``);if(e)return a.layout?{layout:a.layout,component:e.component,params:s}:{component:e.component,params:s}}if(a.children&&c.length>0){let e=i(c,a.children,s);if(e)return a.layout?{layout:a.layout,component:e.component,params:e.params}:e}}return null}function a(e,n){t.currentPath=e,t.currentParams=n?n.params:{},t.currentMatch=n,t.subscribers.forEach(e=>{e(t)})}function o(e){let t=null,r=r=>{let o=n(r),s=i(o,e),c=document.getElementById(`root`);c.innerHTML=``;let l=document.createElement(`div`);if(c.appendChild(l),t&&typeof t.unmount==`function`&&t.unmount(),a(r,s),s)s.layout?(t=new s.layout(l,{...s.params,children:s.component}),t.mount()):s.component&&(t=new s.component(l,s.params),t.mount());else{let n=e.find(e=>e.path===`404`);n&&(t=new n.component(l),t.mount())}},o=e=>{let t=e.target.closest(`a[data-link]`);if(t){e.preventDefault();let n=t.getAttribute(`href`);window.history.pushState({},``,n),r(window.location.pathname)}};return window.addEventListener(`popstate`,()=>{r(window.location.pathname)}),document.body.addEventListener(`click`,o),r(window.location.pathname),{renderRoute:r}}const s={push(e,t={}){t.replace?window.history.replaceState({},``,e):window.history.pushState({},``,e),window.dispatchEvent(new Event(`popstate`))},replace(e){this.push(e,{replace:!0})},back(){window.history.back()},forward(){window.history.forward()},getCurrentRoute(){return{path:t.currentPath,params:t.currentParams,match:t.currentMatch}},isCurrentPath(e){return t.currentPath===e},isCurrentPathStartsWith(e){return t.currentPath.startsWith(e)},subscribe(e){return t.subscribers.push(e),()=>{let n=t.subscribers.indexOf(e);n>-1&&t.subscribers.splice(n,1)}}};function c(){return{...s,state:t}}const l=`modulepreload`,u=function(e,t){return new URL(e,t).href},d={},f=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))},i=document.getElementsByTagName(`link`),a=document.querySelector(`meta[property=csp-nonce]`),o=a?.nonce||a?.getAttribute(`nonce`);r=e(t.map(e=>{if(e=u(e,n),e in d)return;d[e]=!0;let t=e.endsWith(`.css`),r=t?`[rel="stylesheet"]`:``,a=!!n;if(a)for(let n=i.length-1;n>=0;n--){let r=i[n];if(r.href===e&&(!t||r.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${e}"]${r}`))return;let s=document.createElement(`link`);if(s.rel=t?`stylesheet`:l,t||(s.as=`script`),s.crossOrigin=``,s.href=e,o&&s.setAttribute(`nonce`,o),document.head.appendChild(s),t)return new Promise((t,n)=>{s.addEventListener(`load`,t),s.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${e}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[]){if(e.status!==`rejected`)continue;i(e.reason)}return e().catch(i)})};var ee=class{constructor(e,t){this.element=e,this.props=t,this.state={},this.mounted=!1,this.eventListeners=[]}setState(e){this.state={...this.state,...e},this.mounted&&this.render()}addEventListener(e,t,n){e.addEventListener(t,n),this.eventListeners.push({element:e,event:t,handler:n})}mount(){this.mounted=!0,this.onMount(),this.render(),this.attachEventListeners()}unmount(){this.mounted=!1,this.onUnmount(),this.eventListeners.forEach(({element:e,event:t,handler:n})=>{e.removeEventListener(t,n)}),this.eventListeners=[]}onMount(){}onUnmount(){}render(){}attachEventListeners(){}},p=ee,m=class{constructor(t){e.defineProperty(this,`state`,{}),e.defineProperty(this,`listeners`,[]),this.state=t}getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach(e=>e(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}},h=m;const g=new h({isOpen:!1});var _=g,v=class{constructor(e=window.localStorage){this.storage=e,this.listeners={}}get(e){let t=this.storage.getItem(e);try{return JSON.parse(t)}catch{return t}}set(e,t){let n=typeof t==`string`?t:JSON.stringify(t);this.storage.setItem(e,n),this.notify(e)}remove(e){this.storage.removeItem(e)}clear(){this.storage.clear()}subscribe(e,t){return this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t),()=>{this.listeners[e]=this.listeners[e].filter(e=>e!==t)}}notify(e){if(!this.listeners[e])return;let t=this.get(e);this.listeners[e].forEach(e=>e(t))}},y=v;const b=new y;var x=b,S=class extends p{constructor(e,t){super(e,t),this.unsubscribeCartStorage=null,this.unsubscribeRouter=null,this.router=c()}onMount(){this.unsubscribeCartStorage=x.subscribe(`shopping_cart`,()=>{this.render()}),this.unsubscribeRouter=this.router.subscribe(()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage(),this.unsubscribeRouter&&this.unsubscribeRouter()}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{e.target.closest(`#cart-icon-btn`)&&_.setState({isOpen:!0}),e.target.closest(`#back-btn`)&&this.router.back()})}renderNormalHeader(){return`
    ...
    `}render(){let e=this.router.isCurrentPathStartsWith(`/detail`),t=x.get(`shopping_cart`)||[],n=t.length||0;this.element.innerHTML=`
    ...
    `}},C=S,te=class extends p{render(){this.element.innerHTML=`
      <footer class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto py-8 text-center text-gray-500">
          <p>© 2025 항해플러스 프론트엔드 쇼핑몰</p>
        </div>
      </footer>
    `}},ne=te;const w={comma:e=>e.toString().replace(/\B(?=(\d{3})+(?!\d))/g,`,`)},T=new h({isOpen:!1,type:`success`,message:``});var E=T;function D({message:e,type:t=`info`,duration:n=3e3}){T.setState({isOpen:!0,type:t,message:e}),n>0&&setTimeout(()=>{O()},n)}function O(){T.setState({isOpen:!1})}function k(e,t){D({message:e,type:`success`,duration:t})}function A(e,t){D({message:e,type:`info`,duration:t})}var j=class extends p{constructor(e,t){super(e,t),this.unsubscribeCartStorage=null}onMount(){this.unsubscribeCartStorage=x.subscribe(`shopping_cart`,()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage()}closeCartModal(){_.setState({isOpen:!1})}handleSelectAllItems(e){let t=e.map(e=>({...e,isSelected:!e.isSelected}));x.set(`shopping_cart`,t)}handleSelectItem(e,t){let n=e.map(e=>e.productId===t?{...e,isSelected:!e.isSelected}:e);x.set(`shopping_cart`,n)}handleChangeQuantity(e,t,n){let r=e.map(e=>{if(e.productId!==t)return e;let r=e.quantity;return n===`increase`?r+=1:n===`decrease`&&(r=Math.max(1,e.quantity-1)),{...e,quantity:r}});x.set(`shopping_cart`,r)}handleRemoveItem(e,t){let n=e.filter(e=>e.productId!==t);x.set(`shopping_cart`,n),A(`선택한 상품이 삭제되었습니다`)}handleClearAllItems(){x.set(`shopping_cart`,[]),x.remove(`shopping_cart`),A(`장바구니가 비워졌습니다`)}handleSelectedRemoveItem(e){let t=e.filter(e=>!e.isSelected);x.set(`shopping_cart`,t),A(`선택된 상품들이 삭제되었습니다`)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=e.target.closest(`#cart-modal-close-btn`);if(t){this.closeCartModal();return}let n=_.getState(),r=e.target.closest(`#cart-content`);if(!r&&n.isOpen){this.closeCartModal();return}let i=x.get(`shopping_cart`),a=e.target.closest(`.quantity-decrease-btn`);if(a){let e=a.dataset.productId;this.handleChangeQuantity(i,e,`decrease`);return}let o=e.target.closest(`.quantity-increase-btn`);if(o){let e=o.dataset.productId;this.handleChangeQuantity(i,e,`increase`);return}let s=e.target.closest(`.cart-item-checkbox`);if(s){let e=s.dataset.productId;this.handleSelectItem(i,e);return}let c=e.target.closest(`#cart-modal-select-all-checkbox`);c&&this.handleSelectAllItems(i);let l=e.target.closest(`.cart-item-remove-btn`);if(l){let e=l.dataset.productId;this.handleRemoveItem(i,e)}let u=e.target.closest(`#cart-modal-clear-cart-btn`);u&&this.handleClearAllItems();let d=e.target.closest(`#cart-modal-remove-selected-btn`);d&&this.handleSelectedRemoveItem(i)}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.closeCartModal()})}renderCartEmpty(){return`
      <!-- 빈 장바구니 -->
    ...
    `}render(){let e=x.get(`shopping_cart`)||[],t=e.length>0&&e.every(e=>e.isSelected),n=e.filter(e=>e.isSelected),r=n.length||0,i=n.reduce((e,t)=>e+t.lprice*t.quantity,0),a=e.reduce((e,t)=>e+t.lprice*t.quantity,0);this.element.innerHTML=`
      <div
    ...
    `}},M=j;const N={success:{bg:`bg-green-600`,icon:` <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        stroke-width="2"
      ...
      <path
        ...
        d="M6 18L18 6M6 6l12 12"
      />
    </svg>`}};var P=class extends p{constructor(e,t){super(e,t)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=E.getState(),n=e.target.closest(`#toast-close-btn`);n&&t.isOpen&&O()})}renderToast(e,t){let{bg:n,icon:r}=N[e]||N.info;return`
      <div
    ...
    `}render(){let{type:e,message:t}=E.getState();this.element.innerHTML=`<div
      class="fixed bottom-[40px] left-1/2 -translate-x-1/2 "
    >
      ${this.renderToast(e,t)}
    </div>`}},F=P,I=class extends p{constructor(e,t){super(e,t),this.cartInstance=null,this.toastInstance=null,this.unsubscribeCart=null,this.unsubscribeToast=null}render(){this.element.innerHTML=`
    ...
    `,new C(this.element.querySelector(`#header`)).mount(),new ne(this.element.querySelector(`#footer`)).mount(),this.props&&this.props.children&&new this.props.children(this.element.querySelector(`#content`),this.props).mount(),this.updateCart(_.getState()),this.updateCart(E.getState()),this.unsubscribeCart||=_.subscribe(this.updateCart.bind(this)),this.unsubscribeToast||=E.subscribe(this.updateToast.bind(this))}updateCart(e){let t=this.element.querySelector(`#cart`);t&&(this.cartInstance&&(this.cartInstance.unmount(),this.cartInstance=null),t.innerHTML=``,e.isOpen&&(this.cartInstance=new M(t),this.cartInstance.mount()))}updateToast(e){let t=this.element.querySelector(`#toast`);t&&(this.toastInstance&&(this.toastInstance.unmount(),this.toastInstance=null),t.innerHTML=``,e.isOpen&&(this.toastInstance=new F(t),this.toastInstance.mount()))}onUnmount(){this.unsubscribeCart&&this.unsubscribeCart(),this.unsubscribeToast&&this.unsubscribeToast(),this.cartInstance&&this.cartInstance.unmount(),this.toastInstance&&this.toastInstance.unmount()}},L=I;async function R(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);if(!c.ok){let e=await c.json();throw Error(e.message||`상품 목록 조회 실패`)}return await c.json()}async function z(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function B(){let e=await fetch(`/api/categories`);return await e.json()}var V=class extends p{constructor(e,t){super(e,t),this.state={loading:!0,product:null,quantity:1,relatedProducts:null},this.unsubscribeCartStorage=null}async onMount(){let e=await z(this.props.id),t=await R({category1:e.category1,category2:e.category2});this.setState({loading:!1,product:e,relatedProducts:t}),this.unsubscribeCartStorage=x.subscribe(`shopping_cart`,()=>{this.render()})}onUnmount(){this.unsubscribeCartStorage&&this.unsubscribeCartStorage()}handleChangeQuantity(e){e===`increase`?this.setState({...this.state,quantity:this.state.quantity+1}):e===`decrease`&&this.setState({...this.state,quantity:Math.max(1,this.state.quantity-1)})}handleAddCartItem(e,t){let{quantity:n}=this.state,r=e.find(e=>e.productId===t.productId),i;if(r)i=e.map(e=>e.productId===t.productId?{...e,quantity:e.quantity+n}:e);else{let r={...t,quantity:n,isSelected:!1};i=[...e,r]}x.set(`shopping_cart`,i),k(`장바구니에 추가되었습니다`)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{let t=e.target.closest(`.go-to-product-list`);if(t){s.push(`/`);return}let n=e.target.closest(`#quantity-decrease`);if(n){this.handleChangeQuantity(`decrease`);return}let r=e.target.closest(`#quantity-increase`);if(r){this.handleChangeQuantity(`increase`);return}let i=x.get(`shopping_cart`)||[],a=e.target.closest(`#add-to-cart-btn`);if(a){this.handleAddCartItem(i,{productId:this.state.product.productId,title:this.state.product.title,image:this.state.product.image,lprice:this.state.product.lprice});return}let o=e.target.closest(`.related-product-card`);if(o){let e=o.dataset.productId;s.push(`/detail/${e}`);return}let c=e.target.closest(`.breadcrumb-link`);if(c){let e=c.dataset.category1?`?category1=${this.state.product.category1}`:`?category1=${this.state.product.category1}&category2=${this.state.product.category2}`;s.push(`/${e}`)}}),this.addEventListener(this.element,`change`,e=>{let t=e.target.closest(`#quantity-input`);t&&this.setState({...this.state,quantity:t.value})})}renderLoadingUI(){return`
    ...
    `}render(){let{product:e}=this.state;this.element.innerHTML=` <main class="max-w-md mx-auto px-4 py-4">
      ${this.state.loading?this.renderLoadingUI():`
          ...
          `}
    </main>`}},H=V,U=class extends p{render(){this.element.innerHTML=`
    ...
    `}},W=U,re=class extends p{constructor(e,t){super(e,t)}addCartItem(){let{productId:e,title:t,image:n,lprice:r}=this.props,i=x.get(`shopping_cart`)||[],a=i.findIndex(t=>t.productId===e);a>-1?i[a].quantity+=1:i.push({productId:e,title:t,image:n,lprice:r,quantity:1,isSelected:!1}),x.set(`shopping_cart`,i)}attachEventListeners(){this.addEventListener(this.element,`click`,e=>{if(e.target.id===`cart-add-button`){e.stopPropagation(),this.addCartItem(),k(`장바구니에 추가되었습니다`,3e3);return}let t=e.target.closest(`.product-card`);if(t){let e=t.dataset.productId;s.push(`/detail/${e}`)}})}render(){let{productId:e,title:t,image:n,lprice:r,brand:i}=this.props;this.element.innerHTML=`
    ...
    `}},G=re,K=class extends p{constructor(e,t){super(e,t)}render(){this.element.innerHTML=`
    ...
    `}},q=K,J=class extends p{constructor(e,t){super(e,t)}renderNextPageLoading(){return this.props.products&&!this.props.products.pagination.hasNext?``:`
  ...
  `;this.element.innerHTML=`
      ...
      <br />
      ${u}
  `}},me=$;const he=[{path:``,layout:L,children:[{path:``,component:pe},{path:`detail/:id`,component:H},{path:`example`,component:me}]},{path:`404`,component:W}],ge=()=>f(async()=>{let{worker:e}=await import(`./browser-CTZrstzj.js`);return{worker:e}},[],import.meta.url).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`}));function _e(){o(he)}ge().then(_e);